...
export const globalStyles = StyleSheet.create({
  ...
  settingsAvatarSection: { alignItems: 'center', marginBottom: Spacing.xxl },
  settingsAvatar: {
    width: 80,
    height: 80,
    borderRadius: Radii.full,
  ...
  settingsAvatarInitial: { fontSize: 36, fontWeight: FontWeight.bold, color: Palette.white },
  settingsEmailText: { fontSize: FontSize.lg, fontWeight: FontWeight.semibold, color: Palette.text, marginBottom: Spacing.xs },
  settingsMemberText: { fontSize: FontSize.sm, color: Palette.textMuted },
  settingsInfoCard: {
    backgroundColor: Palette.white,
    borderRadius: Radii.xl,
    borderWidth: 1,
  ...
  settingsInfoRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: Spacing.lg, paddingVertical: 14 },
  settingsInfoLabel: { fontSize: FontSize.sm, color: Palette.textSecondary, fontWeight: FontWeight.medium },
  ...
  // ── Backlog ───────────────────────────────────────────────────────────────────
  backlogContainer: { flex: 1, backgroundColor: Palette.background },
  backlogHeader: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  backlogBackBtn: { width: 36, height: 36, alignItems: 'center', justifyContent: 'center' },
  backlogBackBtnText: { fontSize: 32, color: Palette.primary, lineHeight: 36 },
  backlogBackBtnPlaceholder: { width: 36 },
  backlogTitle: { fontSize: FontSize.xxl, fontWeight: FontWeight.bold, color: Palette.text },
  backlogList: { padding: Spacing.lg, paddingBottom: Spacing.xxxl },
  backlogEmpty: { flex: 1, alignItems: 'center', justifyContent: 'center' },
  backlogEmptyText: { fontSize: FontSize.md, color: Palette.textMuted },
  ...
  backlogFabText: { fontSize: 22, color: Palette.white },
  backlogFabBadge: {
    position: 'absolute',
    top: -4,
    right: -4,
